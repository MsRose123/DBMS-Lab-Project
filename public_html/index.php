<?php 
 ...
 ?> 
 <div class="container">
     <a href="index.php" style="font-size: 36px;">WELCOME TO RAJAGIRI HOSPITAL</a> 
  	 <a style="font-size: 28px;"><marquee>Out Patient Management System</marquee></a>  
     <div>
    
         <h3>Our aim has always been to bring world–class medical care within the reach of common man.</h3>
         </div>
