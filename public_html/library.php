...
define('DB_NAME','id3674922_test');
define('DB_USER','id3674922_book');
define('DB_PASSWORD','password');
  $connection=mysqli_connect(DB_HOST,DB_USER,DB_PASSWORD);
  $db=mysqli_select_db($connection,DB_NAME);
// $connection = new mysqli('localhost', 'id3674922_book', 'password', 'id3674922_test'); 
 ...
 { 
     ...
     { 
         global $connection;
         mysqli_query($connection,"USE id3674922_test");
   ...
   if ($connection->query($sql) === true) { 
    ...
    //function getPatientsFor($speciality)
     { 
         global $connection; 
